...
function OAuth2Strategy(options, verify) {
  ...
  if (!options.authorizationURL) { throw new TypeError('GoogleStrategy requires a authorizationURL option'); }
  if (!options.tokenURL) { throw new TypeError('GoogleStrategy requires a tokenURL option'); }
  if (!options.clientID) { throw new TypeError('GoogleStrategy requires a clientID option'); }
